...
mogenerator --swift --model "${INPUT_FILE_PATH}/" --machine-dir "${PROJECT_DIR}/BaseTest/CoreData/Private/" --human-dir "${PROJECT_DIR}/BaseTest/CoreData/" --template-var arc=true
